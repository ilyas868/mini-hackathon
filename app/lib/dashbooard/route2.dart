    ...
    return Stack(
      children: [
        Container(
          ...
          decoration: BoxDecoration(image: DecorationImage(image: AssetImage("assets/images/pic2.png"),fit: BoxFit.cover))
        ),
        Positioned(
          bottom: 290,
          left: 20,
          ...
          bottom: 290,
          right: 300,
          child: Text("2",style: TextStyle(fontSize: 47,color: Colors.white,decoration: TextDecoration.none, fontWeight: FontWeight.bold  ),)),
           Positioned(
          bottom: 250,
          left: 20,
